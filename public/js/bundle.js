        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (!res.data.errors) {
              ...
              (0, _alerts.showAlert)('error', res.data.errors[0].message);
            }
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              ...
              url: 'http://127.0.0.1:3000/graphql',
              data: {
                query: type === 'password' ? "\n                mutation {\n                    updatePassword(\n                        password: \"".concat(data.password, "\"\n                        passwordConfirm: \"").concat(data.passwordConfirm, "\"\n                        passwordCurrent: \"").concat(data.passwordCurrent, "\"\n                    ) {\n                        name\n                    }\n                }\n            ") : "\n                mutation {\n                    updateMe(\n                        name: \"".concat(userData.name, "\"\n                        email: \"").concat(userData.email, "\"\n                    ) {\n                        name\n                        email\n                    }\n                }\n            ")
              }
            });
...
var stripe = Stripe('pk_test_51HbRbsJcHVDv2N69BYpnNgDxP8azpPnZWpjecT8WOO7HUiqrjRYIM2pvV9iJKjRXIjKnnaLqqXE4TZWXhzXN7RHw00T0BdbxxS');
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              ...
              url: 'http://127.0.0.1:3000/graphql',
              data: {
                query: "\n              query {\n                getCheckoutSession(tourId: \"".concat(tourId, "\")\n              }\n          ")
              }
            });
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "62864" + '/');
